...
class User(AbstractUser):
    ...
    avatar_url = models.CharField(max_length=100, null=True, verbose_name="回答者头像")
...
class Answer(models.Model):
    ...
    nickname = models.CharField(max_length=20, default="匿名", db_index=True, verbose_name="昵称")
    question_id = models.BigIntegerField(null=False, db_index = True, verbose_name='问题编号')
    question_title =  models.CharField(max_length=200,null=False,verbose_name="回答的问题标题")
    url_token = models.CharField(max_length=50, null=False, verbose_name="回答的问题标题")

    content = models.CharField(max_length=4096, null=False,verbose_name='回答内容')
    avatar_url = models.CharField(max_length=100, null=True, default="'images/default.jpg",
                                  verbose_name="回答者头像")

    slogan = models.CharField(max_length=25, null=True, verbose_name="回答者简介")
    status = models.SmallIntegerField(null=False, default= 0, verbose_name="审核状态")
...
class Comment(models.Model):
    ...
    comment_id = models.IntegerField(null=True, verbose_name="父级评论ID")
    nickname = models.CharField(max_length=30,null=False, verbose_name="评论者昵称")
    other_userid = models.IntegerField(null=True,verbose_name="回复者ID")
    other_nickname = models.CharField(max_length=30, null=True, verbose_name="回复者昵称")
